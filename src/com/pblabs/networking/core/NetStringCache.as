package com.pblabs.networking.core
{
   ...
   public class NetStringCache
   {
      ...
      {
         Logger.print(this, "Usage Report");
         Logger.print(this, "   - " + readCount + " reads, " + cachedReadCount + " cached (" 
               + (cachedReadCount / readCount)*100.0 + "% cached.)");
         Logger.print(this, "   - " + writeCount + " writes, " + cachedWriteCount + " cached (" 
         ...
         Logger.print(this, "   - " + numUsed + " out of " + entryCount + " IDs in use (" 
               + (Number(numUsed) / Number(entryCount))*100.0 + "% utilization.)");
         
         // Note efficiency on IO...
         Logger.print(this, "   - " + bytesRead + " bytes read, " + bytesEmitted + " bytes emitted." +
               "(factor of " + (bytesEmitted/bytesRead) + " advantage)");
         Logger.print(this, "   - " + bytesWritten + " bytes written, " + bytesSubmitted + " bytes submitted." + 
