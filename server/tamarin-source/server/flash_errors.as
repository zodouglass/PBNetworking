...
package flash.errors
{
    ...
    /* note:
       when we will need to throw those errors from C/C++
       we will need to declare those in the avmshell
       like what is done in the toplevel avmplus error classes
       
       ex:
       ErrorClass.h:   typedef NativeErrorClass SecurityErrorClass;
       Toplevel.cpp:   ErrorClass* Toplevel::securityErrorClass() const { return getErrorClass(avmplus::NativeID::abcclass_SecurityError); }
       Toplevel.h:     ErrorClass* securityErrorClass() const;
       
       and also define metdatas
    */
