...
# compile builtins
os.system(asc+" -d -abcfuture -import ../core/builtin.abc -builtin -out shell_toplevel shellmaster.as")

print("Generating native thunks...")
os.system(sys.executable + " ../utils/nativegen.py ../core/builtin.abc shell_toplevel.abc")
